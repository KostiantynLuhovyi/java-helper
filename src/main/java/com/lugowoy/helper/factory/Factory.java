 ...
 * <p>Created by Konstantin Lugowoy on 05-Jan-18.
 *
...
public class Factory<T> implements Creating<T> {
    ...
    /**
     * Constructor with a parameter that takes an object of the class that implements the contract interface {@link Creating}
