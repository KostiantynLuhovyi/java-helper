...
/**
 * Functional interface that declares a contract and provides a function to perform the conversion of object data.
...
public interface Converting<T> {
    ...
    /**
     * Method (function) that converts the data of an object passed into a parameter.
     *
