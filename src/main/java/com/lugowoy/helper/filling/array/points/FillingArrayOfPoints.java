...
public interface FillingArrayOfPoints<T extends Number> extends FillingArray<Point<T>> {
     ...
     *
     * @param array The object of the {@link Array} class to be filled with objects of the {@link Point} class with numerical coordinates.
     * @return The object of the {@link Array} class filled with objects of the {@link Point} class with numerical coordinates.
     */
    @Override
    Array<Point<T>> fill(Array<Point<T>> array);
     ...
     * */
    Array<Point<T>> fill(Array<Point<T>> array, T bound);
     ...
     * @return The array filled with objects of the {@link Point} class with numerical coordinates.
     * */
    Point<T>[] fill(Point<T>[] points, T bound);
