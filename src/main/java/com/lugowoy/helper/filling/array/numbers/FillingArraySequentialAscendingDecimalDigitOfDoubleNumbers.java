...
public class FillingArraySequentialAscendingDecimalDigitOfDoubleNumbers implements FillingArrayNumbers<Double> {
     ...
     * If the value of the "bound" argument is a negative number, then the range value for filling the array from "0" to {@link DefaultValuesOfArray#DEFAULT_DOUBLE_POSITIVE_BOUND}.
     *
     * @param array The object of the {@link Array} class to be filled with
     *              sequential ascending decimal digit of numeric data of type {@link Double}.
    ...
    public Double[] fill(int lengthArray, Double bound) {
        ...
        if (checkLengthArray(lengthArray)) {
            ...
            if (checkBoundValueIsPositive(bound)) {
                ...
                this.initializeArrayElementsSequentialAscendingDecimalDigitOfDoubleNumbersFromZeroToPositiveBound(doubles,
    ...
    private void initializeArrayElementsSequentialAscendingDecimalDigitOfDoubleNumbers(Double[] doubles) {
    ...
    private void initializeArrayElementsSequentialAscendingDecimalDigitOfDoubleNumbersFromZeroToPositiveBound(Double[] doubles, double bound) {
        double value = 0, fractionalDigit = 0.1;
        for (int i = 0; i < doubles.length; i++) {
            if (value <= bound) {
                doubles[i] = value;
    ...
    private void initializeArrayElementsSequentialAscendingDecimalDigitOfDoubleNumbersFromStartBoundToEndBound(Double[] doubles, double startBound, double endBound) {
