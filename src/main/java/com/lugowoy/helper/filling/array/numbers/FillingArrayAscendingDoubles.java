 ...
 * An increase in the number of type {@link Double} for filling occurs by the integer part of the number (ex.: 2.3, 3.3, 3.4, ...).
...
public class FillingArrayAscendingDoubles implements FillingArrayNumbers<Double> {
     ...
     * occurs on the integer part of the number by 1.0 (ex.: 1.0, 2.0, 3.0, ...).
     *
