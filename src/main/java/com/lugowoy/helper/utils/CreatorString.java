...
public final class CreatorString {
    ...
    /**
     * Creates a string of length as a {@code lengthString} argument from the pseudo-random characters
     * contained in the {@code characters} array.
     *
     ...
     * from 0 to {@link Integer#MAX_VALUE}.
    ...
    /**
     * Creates a string with a length as a pseudo-random number ranging from {@code lowerBoundLength}
     * to {@code upperBoundLength} and containing pseudo-random characters contained in the {@code characters} array.
     *
     * @param characters the array of characters from which the string creates.
